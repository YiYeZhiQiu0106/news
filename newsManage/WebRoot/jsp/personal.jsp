            ...
            <div class="container">
                ...
                <div class="column-one-third">
					...
					<div style="height:285px;" class="outerwide">
							<span><b>------ 我的微头条</b></span></h5>
                        	<ul class="block2">
                        		<c:forEach items="${list }" var="news">
                        			<c:if test="${news.n_state < 5 || news.n_state == 6}">
	                        		<li>
	                                   ...
	                                   <c:if test="${news.n_state < 5}">
	                                   	<font color="#44EA1C">已发布</font>
	                                    </c:if>
	                                    
	                                    <c:if test="${news.n_state == 6}">
	                                   	<font color="#F3841C">待审核</font>
	                                    </c:if>
	                                </li>
	                                </c:if>
                        		</c:forEach>
				...
				<div class="pager">
                            <ul>
                                <c:forEach begin="1" end="${pagenum }" varStatus="st">
                            		<li><a href="${pageContext.request.contextPath}/nuserNews/showNuserNewsPage.action?pagenum=${st.index }&u_id=${nuser.u_id}">${st.index }</a></li>
                            	</c:forEach>
                            </ul>
                        </div>
        </section>
