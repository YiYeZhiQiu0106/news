    ...
    <div class="controller2">
        ...
        <section id="content">
            <div class="container">
                ...
                <div class="breadcrumbs column" id="bc">
                	<p><a href="${pageContext.request.contextPath}/news/findAllNews.action">Home.\\  </a><font color="white">${news.type_name}</font></p>
                </div>
                	...
                	<div class="column-two-third">
                    	<div class="outertight m-t-no">  	
	                            <div class="flexslider">
	                                <ul class="slides">
	                                    <li>
	                                    	<a href="${pageContext.request.contextPath}/news/findOneNewsByID.action?n_id=${listtop[0].n_id }">
	                                        	<img width="300px" height="168px" src="${pageContext.request.contextPath}/jsp/img/news/${listtop[0].n_img}" alt="MyPassion" />
	                                        </a>
	                                    </li>  
	                                </ul>
	                            </div>
	                            
	                            <h6 class="regular"><a href="${pageContext.request.contextPath}/news/findOneNewsByID.action?n_id=${listtop[0].n_id }">${listtop[0].n_title }</a></h6>
	                           <span class="meta">${listtop[0].n_time }</span>
	                        <p>${listtop[0].n_text}</p>
                        </div>
		                <div class="outertight m-r-no m-t-no"> 
			                  <div class="flexslider">
			                       <ul class="slides">
			                            <li>
			                                 <a href="${pageContext.request.contextPath}/news/findOneNewsByID.action?n_id=${listtop[1].n_id }">
			                                 <img width="300px" height="168px" src="${pageContext.request.contextPath}/jsp/img/news/${listtop[1].n_img}" alt="MyPassion" />
			                                 </a>
			                            </li>                                
			                       </ul>
			                  </div>
			                  <h6 class="regular"><a href="${pageContext.request.contextPath}/news/findOneNewsByID.action?n_id=${listtop[1].n_id }">${listtop[1].n_title }</a></h6>
			                  <span class="meta">${listtop[1].n_time }</span>
			                  <p>${listtop[1].n_text}</p>
		                 </div>

                        
                        
                        <div class="outerwide">
                        	<ul class="block2" id="bc2">
                        ...
                        <div class="pager">
                            <ul>               
                            	<c:forEach items="${page }" var="page">
                            		<li><a href="${pageContext.request.contextPath}/news/findNewsBypage.action?pagenum=${page }&typeid=${list[0].type_id}">${page }</a></li>
                            	</c:forEach>
